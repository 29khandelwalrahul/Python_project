    ...
    def __init__(self, window):
        ...
        def popular_searches(name):
            if (name == 'b'):
                ...
                for p in range(0, len(all_b), 2):
                    ...
                    text_b.insert(INSERT, "Click to read the article..",
                                  hyperlink.add(partial(webbrowser.open, all_b[p + 1])))
                    text_b.insert(INSERT, "\n")
                    text_b.insert(INSERT, "\n")
        ...
        #------------------------------------------------------------------------------------------------------------
            ...
            if (name == 't'):
                ...
                for p in range(0, len(all_t), 2):
                    ...
                    text_t.insert(INSERT, "Click to read the article..",
                                  hyperlink.add(partial(webbrowser.open, all_t[p + 1])))
                    text_t.insert(INSERT, "\n")
                    text_t.insert(INSERT, "\n")
        ...
        #-------------------------------------------------------------------------------------------------------
            ...
            if (name == 'et'):
                ...
                img = Image.open('entertainment.jpg')
                img = img.resize((1200, 675), Image.Resampling.LANCZOS)
                self.photobg = ImageTk.PhotoImage(img)
                s = Label(section, image=self.photobg)
                s.place(x=0, y=0)

                url_et = "https://timesofindia.indiatimes.com/tv/news/hindi"
                ...
                figure_et = soup_et.find_all('p',class_="hasfilter")
                for ha in (figure_et):
        ...
        p1 = Button(Boardframe, text='Business', bg='papaya whip', cursor='hand2', relief=FLAT, foreground='black',
                    width=15, height=2, activebackground='orange', command=lambda: popular_searches('b')).place(x=40,
                                                                                                                y=50)
        p2 = Button(Boardframe, text='Technology', bg='peach puff', cursor='hand2', relief=FLAT, foreground='black',
                    width=15, height=2, activebackground='orange', command=lambda: popular_searches('t')).place(x=170,
                                                                                                                y=50)
        p3 = Button(Boardframe, text='Sports', bg='lavender', cursor='hand2', relief=FLAT, foreground='black', width=15,
                    height=2, activebackground='orange', command=lambda: popular_searches('s')).place(x=300, y=50)
        p4 = Button(Boardframe, text='News', bg='lavender', cursor='hand2', relief=FLAT, foreground='black', width=15,
                    height=2, activebackground='orange', command=lambda: popular_searches('n')).place(x=430, y=50)
        p5 = Button(Boardframe, text='Entertainment', bg='cadet blue', cursor='hand2', relief=FLAT, foreground='black',
                    width=15, height=2, activebackground='orange', command=lambda: popular_searches('et')).place(x=560, y=50)
        p6 = Button(Boardframe, text='Education', bg='#116562', cursor='hand2', relief=FLAT, foreground='black',
                    width=15, height=2, activebackground='orange', command=lambda: popular_searches('e')).place(x=690, y=50)

        # submit button
        btn = Button(Boardframe, text="Search", width=17, height=3, foreground="black", relief=RAISED, cursor='hand2',
                     background="yellow", command=search).place(x=372, y=120)
        ...
        def recent_searches(list):
            ...
            s = Button(rs, text='Search', width=17, height=3, foreground="black", relief=RAISED, background="gold",
                       command=search).place(x=70, y=400)

        rsbtn = Button(window, text="Recent Searches", cursor='hand2', width=17, height=3, foreground="black",
                       relief=RAISED, background="SlateGray4", font=1,
                       command=lambda: recent_searches(recent_serach)).place(x=480, y=300)
        ...
        def topten_searches(list):
            ...
            s = Button(t10, text='Search', width=17, height=3, foreground="black", relief=RAISED, background="gold",
                       command=search).place(x=70, y=400)

        t10btn = Button(window, text="Top 10 searches on our website", cursor='hand2', width=35, height=2,
                        foreground="black", relief=RAISED, background="plum3", font=1,
                        command=lambda: topten_searches(top10_serach)).place(x=390, y=450)


window = Tk()

img = Image.open('web-cr.jpg')
img = img.resize((1200, 675), Image.Resampling.LANCZOS)
